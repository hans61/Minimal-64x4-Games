...
key_up:    
        LDI 4 SDB delta
        LDI 0 SDB idxA JPS chkField
        LDI 1 SDB idxA JPS chkField
        LDI 2 SDB idxA JPS chkField
        LDI 3 SDB idxA JPS chkField
        JPA gameLoop
key_down:
        LDI -4 SDB delta
        LDI 12 SDB idxA JPS chkField
        LDI 13 SDB idxA JPS chkField
        LDI 14 SDB idxA JPS chkField
        LDI 15 SDB idxA JPS chkField
        JPA gameLoop
key_right:
        LDI -1 SDB delta
        LDI 3 SDB idxA JPS chkField
        LDI 7 SDB idxA JPS chkField
        LDI 11 SDB idxA JPS chkField
        LDI 15 SDB idxA JPS chkField
        JPA gameLoop
key_left:
        LDI 1 SDB delta
        LDI 0 SDB idxA JPS chkField
        LDI 4 SDB idxA JPS chkField
        LDI 8 SDB idxA JPS chkField
        LDI 12 SDB idxA JPS chkField
        JPA gameLoop
    
gameOver:
        LDI 13 SDB _XPos LDI 3 SDB _YPos
        JPS printLine
        ' *********** ', 0x00,
        LDB gameWin
        CPI 0x00
        BNE winner
        LDI 13 SDB _XPos INB _YPos
        JPS printLine
        '* GAME OVER *', 0x00,
        JPA gameOv1
winner:    LDI 13 SDB _XPos INB _YPos
        JPS printLine
        '*  YOU WIN  *', 0x00,
gameOv1:
        LDI 13 SDB _XPos INB _YPos
...
printHelp:
        ...
        LDI 3 SDB _XPos INB _YPos INB _YPos INB _YPos
        JPS printLine
        'USE CURSOR KEYS OR I,J,K,M TO MOVE', 0x00,
        LDI 10 SDB _XPos INB _YPos INB _YPos
        JPS printLine
        'N RESTARTS THE GAME', 0x00,
        LDI 12 SDB _XPos INB _YPos INB _YPos
        JPS printLine
        'Q QUIT THE GAME', 0x00,

        LDI 9 SDB _XPos INB _YPos INB _YPos INB _YPos
        JPS printLine
        'PRESS ANY KEY TO PLAY', 0x00,
        RTS
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
printTitle:
        LDI 12 SDB _XPos LDI 2 SDB _YPos
        JPS printLine
...
chkMove:
        LDI 1 SDB delta
        LDI 0 SDB idxA JPS chkLine
        CPI 0x00 BNE retTrue
        LDI 4 SDB idxA JPS chkLine
        CPI 0x00 BNE retTrue
        LDI 8 SDB idxA JPS chkLine
        CPI 0x00 BNE retTrue
        LDI 12 SDB idxA JPS chkLine
        CPI 0x00 BNE retTrue
        LDI 4 SDB delta
        LDI 0 SDB idxA JPS chkLine
        CPI 0x00 BNE retTrue
        LDI 1 SDB idxA JPS chkLine
        CPI 0x00 BNE retTrue
        LDI 2 SDB idxA JPS chkLine
        CPI 0x00 BNE retTrue
        LDI 3 SDB idxA JPS chkLine
        RTS
chkLine:                      ; 
        LDB idxA SDB idxL SDB idxB
...
chk02:  INB flagM
        ...
        JPA chkLoop
        ; array(idxA) = Value
chk04:  SDB tmp01           ; array(idxA) remember 
...
storeArray:
        LDI <array SDB storeA1+1
        LDI >array SDB storeA1+2
        LDS 3
        ADW storeA1+1
        LDS 4
storeA1:
...
loadArray:
        LDI <array SDB loadA1+1
        LDI >array SDB loadA1+2
        LDS 3
        ADW loadA1+1
loadA1: LDB 0xffff
        SDS 3
...
incArray:
        LDI <array SDB incA1+1
        LDI >array SDB incA1+2
        LDS 3
        ADW incA1+1
incA1:  INB 0xffff
        SDS 3
...
checkArray:
        ...
        SDB fieldId
        CLB count2
        LDI <array SDB checkA1+1
        LDI >array SDB checkA1+2
checkA1:
        LDB 0xffff
        CPI 0x00
        BNE checkA2
...
print24x24:
        ...
        SDZ 0                 ; X = A
        LZB 0, coordinates
        SDB adress+0          ;{{sprite addr lo}}
        INZ 0
        LZB 0, coordinates
        SDB adress+1          ;{{sprite addr hi}}
        
        LDB sprId
        LL1                   ; A = 2 * A
        SDZ 0                 ; X = A
        LZB 0, spriteAddr16
        SDB spoint+0          ;{{sprite addr lo}}
        INZ 0
        LZB 0, spriteAddr16
        SDB spoint+1          ;{{sprite addr hi}}
